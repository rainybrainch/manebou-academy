...
const sections = [
  {
    ...
    icon: '📱',
    steps: [
      'ホーム画面から「続きから始める」ボタンで前回のレッスンに戻れます',
      '「コース一覧」でカテゴリ→章→講義の順に学習できます',
      '各講義を最後まで読んで「講義を完了にする」を押すと進捗が記録されます',
      '間違って完了にした場合は、完了ボタン横の「取り消し」ボタンで戻せます',
      'ホームの「今日の一問」は毎日更新のクイズです。「もう一問」でさらに練習できます',
  ...
  },
  {
    ...
    steps: [
      ...
      'メモはMarkdown形式でエクスポートしてダウンロードすることもできます',
    ],
  },
  {
    title: '実績トロフィー',
    icon: '🏆',
    steps: [
      '学習の節目に26種類の実績バッジが解除されます',
      '例：「最初の一歩（1講義完了）」「三日坊主に勝った（3日連続）」「50講義の頂（50講義）」「超集中学習（1日5講義）」など',
