...
const FAQ_SECTIONS: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: '連続学習日数（ストリーク）はどう計算されますか？',
        a: '前日に学習した場合に翌日のストリークが +1 されます。2日以上間隔が空くとリセットされます。毎日1講義以上完了することでカウントされます。',
      },
      {
        q: '実績はどうすれば獲得できますか？',
        a: '講義完了数・連続学習日数・特定の行動（チェックリスト全完了・いいね5件以上など）で獲得できます。学習レポートページの「実績」カードで進捗と残り条件を確認できます。',
      },
      {
        q: '今日の復習クイズはどのように出題されますか？',
        a: 'ホーム画面の「今日の復習クイズ」は、あなたが完了済みの講義から練習問題をランダム抽出して毎日1問出題されます。未完了の講義が増えるほど問題が充実します。',
      },
      {
        q: '学習成果をSNSでシェアできますか？',
    ...
    items: [
      {
        ...
        a: '講義ページで「←」「→」で前後の講義に移動、「C」で講義を完了、「F」でフォーカスモードを切替できます。「?」キーでショートカット一覧を表示できます。',
      },
      {
        q: 'フォーカスモードとは何ですか？',
        a: '講義ページで「F」キーまたはヘッダーの⤡ボタンを押すと、ヘッダーとナビゲーションが非表示になり、講義コンテンツだけに集中できるモードです。再度「F」を押すか画面右上のチップをタップすると解除されます。',
      },
      {
        q: '用語集ページはありますか？',
        a: 'はい、下部ナビゲーションの「GLOSSARY（用語集）」から全講義で登場したキーワードを一覧で確認できます。検索機能もあり、気になる用語をすぐに調べられます。',
      },
      {
        q: 'ZAiゲームとは何ですか？',
    ...
    items: [
      {
        ...
        a: '現在5つのカテゴリがあります。①お金の基本コース（7章39講義・初心者向け）②日本経済と社会のお金（3章12講義・社会の仕組み）③ZAiゲームで学ぶ株式投資（ゲーム連動）④株式投資入門⑤NISAで始める資産運用。まずは「お金の基本コース」から始めるのがおすすめです。',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: '実績バッジはどんな種類がありますか？',
        a: '現在26種類の実績があります。「最初の一歩（1講義完了）」「3週間連続（21日連続学習）」「50講義の頂（50講義完了）」「100講義の奇跡（100講義完了）」「チェック魔（10講義のチェックリスト全完了）」「集中学習（1日3講義以上）」「超集中学習（1日5講義以上）」「メモの達人（10講義にメモ）」「いいね上手（10講義にいいね）」などです。学習レポートページの「実績トロフィー」カードから確認できます。',
      },
      {
        q: '「いいね」ボタンは何に使いますか？',
      ...
      },
      {
        ...
        a: '学習レポートページの「すべてのメモ」カードに「Markdownでエクスポート」ボタンがあります。全講義のメモをまとめたMarkdownファイルとしてダウンロードできます。',
      },
      {
