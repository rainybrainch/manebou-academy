...
const FAQ_SECTIONS: FaqSection[] = [
  ...
  },
  {
    ...
    items: [
      {
        q: '実績バッジはどんな種類がありますか？',
        a: '現在34種類の実績があります。講義数系（5/10/15/20/25/30/40/50/60/75/100講義）・連続学習系（3日/1週間/2週間/3週間/1ヶ月連続、週間パーフェクト）・行動系（集中学習・超集中学習・チェック魔・メモ魔・いいね魔・メモの達人・いいね上手）・クイズ系（一問入魂・クイズマスター）・攻略系（章マスター・カテゴリ制覇・完全制覇）などです。学習レポートページの「実績トロフィー」カードから確認できます。',
      },
      {
        q: '「いいね」ボタンは何に使いますか？',
