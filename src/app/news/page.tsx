...
const updates = [
  {
    date: '2026-06-17',
    tag: '改善',
    title: 'ランダム講義スピン時のタイマークリーンアップ修正',
    body: 'ランダム講義を選ぶ際の400msのスピン・アニメーション中にコンポーネントがアンマウントされた場合、タイマーがクリアされずに親コンポーネントへのロダーシュを試みていた問題を修正しました。useRefを使用してタイマーを追跡し、クリーンアップ効果で確実に解放されるようになりました。',
  },
  {
    date: '2026-06-17',
    tag: '改善',
