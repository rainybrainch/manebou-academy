...
const QUOTES = [
  ...
  { text: 'お金の知識は、一生使える武器になる。', author: 'Monebou Academy' },
  ...
  { text: '投資は才能ではなく、習慣で決まる。', author: 'Monebou Academy' },
  ...
  { text: '成功した投資家と失敗した投資家の違いは、才能ではなく行動だ。', author: 'Monebou Academy' },
  ...
  { text: '知識のない人が投資をすると、それは投資ではなく賭けだ。', author: 'Monebou Academy' },
  { text: '節約は未来への贈り物だ。今の自分が未来の自分に贈る、最高のプレゼント。', author: 'RBAI格言' },
  { text: '家計簿をつけることは、自分のお金の使い方を「見える化」することだ。知ることから変化は始まる。', author: 'RBAI格言' },
  { text: 'iDeCoは節税しながら老後に備えられる最強のツールだ。今の税金を未来の自分に貯める感覚で活用せよ。', author: 'Monebou Academy' },
