        ...
        <div className="px-4 py-2.5 shrink-0" style={{ background: 'rgba(26,26,46,0.04)', borderBottom: '1px solid rgba(26,26,46,0.08)' }}>
          ...
          <div className="h-1.5 rounded-full overflow-hidden" style={{ background: 'rgba(26,26,46,0.1)' }}>
            <div
              ...
              style={{ width: `${mounted ? pct : 0}%`, background: '#4CAF7D' }}
            />
          </div>
        </div>
          ...
          {chapters.map((chapter) => {
            ...
            return (
              <div key={chapter.id}>
                ...
                >
                  {chapterDone && (
                    <svg className="w-3 h-3 shrink-0" style={{ color: '#4CAF7D' }} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background: done ? '#4CAF7D' : isCurrent ? 'var(--mb-gold)' : 'rgba(26,26,46,0.08)',
                        }}
                      >
                        {done ? (
