      ...
      lessons: [
        {
          ...
          sections: [
            ...
            {
              type: 'text',
              content: '**完全ダイアログ例**\n\n**店員：**"어서오세요! 몇 분이세요?"\n**あなた：**"두 명이에요."\n\n**店員：**"이쪽으로 앉으세요."\n**あなた：**"고마워요."\n\n**店員：**"뭘 드시겠어요?"\n**あなた：**"비빔밥이랑 불고기 부탁해요. 덜 맵게 해주세요."\n\n**店員：**"반찬은 충분해요?"\n**あなた：**"네, 좋아요."\n\n**店員：**"음료는 어떻게 하실래요?"\n**あなた：**"콜라 두 잔 주세요."\n\n**店員：**"알겠습니다. 잠깐만요."\n\n--- 食事中 ---\n\n**店員：**"맛있게 드세요!"\n**あなた：**"감사합니다!"\n\n--- 食事後 ---\n\n**あなた：**"정말 맛있었어요! 계산해주세요."\n**店員：**"감사합니다. 35,000원이에요. 현금인가요, 카드인가요?"\n**あなた：**"카드로 부탁해요."\n**店員：**"알겠습니다. 잠깐만요... 완료됐습니다. 감사합니다!"\n**あなた：**"고마워요! 정말 맛있었어요!"',
            },
          ],
        },
        {
          ...
          sections: [
            ...
            {
              type: 'text',
              content: '**シーン1：朝の天気チェック**\n**A：**"오늘 날씨 어때?"\n**B：**"오늘은 맑고 따뜻할 거 같아. 외출하기 좋아!"\n**A：**"정말? 산책 갈래?"\n**B：**"그래! 우산은 안 가져가도 돼."\n\n**シーン2：天気の心配**\n**A：**"내일 날씨가 어떻게 될까?"\n**B：**"일기예보에서는 비가 올 거라고 했어. 우산을 챙겨야 해."\n**A：**"정말? 그럼 소풍을 연기해야겠네."\n**B：**"주말에 날씨가 좋아질 거 같으니까 그때 하자!"\n\n**シーン3：季節の変わり目**\n**A：**"날씨가 정말 좋네요!"\n**B：**"맞아요. 가을이라 날씨가 최고야."\n**A：**"내일도 맑을까요?"\n**B：**"내일은 흐릴 거 같아. 우산 챙겨."\n**A：**"겨울이 언제 시작해요?"\n**B：**"12월부터지. 눈도 많이 올 거야."\n**A：**"정말? 스키 타러 가고 싶어!"\n**B：**"좋은 생각이야! 같이 가자!"',
            },
          ],
        },
        {
          ...
          sections: [
            ...
            {
              type: 'text',
              content: '**嬉しい場面**\n**A：**"드디어 만났어!"\n**B：**"정말! 너무 반가워. 오랜만이야!"\n**A：**"나도 너무 행복해!"\n**B：**"무슨 좋은 일이 있어? 기쁜 표정인데?"\n**A：**"맞아! 시험에 합격했어!"\n**B：**"진짜? 축하해! 우리 함께 축하 파티하자!"\n\n**悲しい場面**\n**A：**"뭐야? 왜 그렇게 슬픈 표정이야?"\n**B：**"...나 지금 정말 외로워. 혼자라고 생각해."\n**A：**"괜찮아. 내가 옆에 있어."\n**B：**"고마워... 너만 있으면 충분해..."\n**A：**"항상 함께할 거니까."\n\n**怒った場面**\n**A：**"넌 나한테 뭐 했어?!"\n**B：**"미안해... 정말 미안해. 화내지 마..."\n**A：**"화났지! 어떻게 날 이렇게 속상하게 할 수 있어!"\n**B：**"내가 잘못했어. 다시는 안 할 거니까. 용서해줄래?"\n**A：**"(한숨)... 좋아. 하지만 다시는 안 돼."\n**B：**"알겠어. 고마워, 정말 고마워."',
            },
          ],
        },
      ],
      ...
      lessons: [
        ...
        },
        {
          ...
          sections: [
            ...
            {
              type: 'text',
              content: '**同じ「愛してる」でも**\n\n**1. 敬語で告白（初デート）**\n- "저도 좋아해요..." - 私もお好きです...（慎重・真摯）\n- "만나주셔서 감사합니다" - お会いくださってありがとうございます\n\n**2. タメ口で告白（長く付き合った後）**\n- "난 너를 정말 사랑해..." - 僕は君を本当に愛してる...（深い・親密）\n- "너만 있으면 돼" - 君だけで十分だ\n\n**3. 最敬語で公式宣言（結婚式など）**\n- "저는 그녀를 사랑합니다" - 私は彼女を愛しています（正式・宣言的）\n- "평생 함께하겠습니다" - 一生一緒にいます（結婚の誓い）\n\n**ビジネス場面での敬語**\n- "말씀하셨듯이..." - おっしゃった通り...（上司の意見を尊重）\n- "검토해주셨군요" - ご検討ありがとうございました\n- "의견을 주셔서 감사합니다" - ご意見をいただきありがとうございます',
            },
          ],
        },
        {
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              type: 'highlight-box',
              title: 'シーン別：心理背景を読む',
              content: '**雨のシーン：涙が止まらない告白**\n- "난 너... 너 없이는 살 수 없어..." - 僕は君なしでは生きられない...（極限の心情）\n- "처음부터 너였어..." - 最初からお前だった...（深い絆）\n\n**夜の屋上：決意のセリフ**\n- "이제부터 나 옆에만 있어" - これからは僕のそばにいてね（強い願い）\n- "영원히 함께할 거야" - 永遠に一緒にいようね（誓い）\n\n**別れのシーン：涙で言葉が出ない**\n- (沈黙 + 涙) が最も強いロマンス表現\n- "미안해... 정말로..." - ごめん... 本当に...（言葉にならない後悔）\n\n**再会のシーン：時間を超えた思い**\n- "그래도 넌... 나한테 특별해" - それでも君は... 僕にとって特別だ（時を超えた思い）',
            },
            {
              type: 'heading',
              level: 2,
              content: 'ドラマの定番ロマンティックシーンと表現',
            },
            {
              type: 'text',
        ...
        },
        {
          ...
          sections: [
            ...
            },
            {
              type: 'highlight-box',
              title: '例題：ドラマシーン翻訳',
              content: '**【例題1】**\n**原文：**\nA: "너 왜 이래?"\nB: "난 모르겠어..."\n\n**意訳案：**\nA: "お前どうしたんだよ？"（タメ口・親友同士）\nB: "わかんない..." （切実感）\n\n**解説：**\n- "너 왜 이래?" は友人同士のタメ口\n- 「お前」という日本語は敵意ではなく、親密さの表現\n- "난 모르겠어" は「わかんない」ではなく「どうしたらいいかわかんない」という絶望感\n\n**【例題2】**\n**原文：**\n"계속 옆에 있어줄래?"\n\n**意訳案：**\n"ずっとそばにいてくれる？"（懇願・愛情表現）\n\n**解説：**\n- "-ㄹ래?" は「〜してくれる？」という相手への願いの表現\n- 敬語ではなくタメ口だから、親密な関係での切実な願い\n- 日本語の「ずっと」が時間の長さと不変さを両方表現',
            },
            {
              type: 'heading',
              level: 2,
              content: '1分問題集の進め方：実践的な例',
            },
            {
              type: 'text',
